...
export class DbService {
    ...
    private async seedAppointments(createdDoctors: any[], createdPatients: any[]) {
        ...
        if (allDoctors.length === 0 || createdPatients.length === 0) {
            this.logger.warn('⚠️ Not enough data to generate appointments (missing doctors or patients).');
            return;
        }
